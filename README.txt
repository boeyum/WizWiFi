...
The devices' recognition is not based on the type of device, but on which functionality the device has (dimmable, white color adjustable, color etc.). Therefore, most light sources from Wiz should be supported. 
In addition, there is support for smart plugs with and without current measurement.
